...
(declare-fun __dummy_A30_0T43@0__ (T@U) Bool)
(assert (! (__dummy_A30_0T43@0__ (optsome fresh_T@T_0 (optget fresh_T@T_0 (optnone fresh_T@T_0)))) :named Dummy_A30_0T43@0 ))
(check-sat)