...
(declare-fun j_2!50!2 () Int)
(declare-fun j_2@@1!51!3 () Int)
(declare-fun j_2_1!50!1 () Int)
...
(assert (! (forall ((a_3py0 T@U)(i_1py0 Int)) (! (and (= (first (loc a_3py0 i_1py0)) a_3py0) (= (second (loc a_3py0 i_1py0)) i_1py0)) :pattern ((loc a_3py0 i_1py0)) )) :named A30))
(assert (! (forall ((a_3@@0py0 T@U)) (! (<= 0 (len a_3@@0py0)) :pattern ((len a_3@@0py0)) )) :named A31))
(assert (! (not (IsPredicateField NormalFieldType intType val)) :named A32))
(assert (! (not (IsWandField NormalFieldType intType val)) :named A33))
(assert (! (forall ((arg0@@10py0 T@T)(arg1@@4py0 T@T)) (! (= (FieldTypeInv1 (FieldType arg0@@10py0 arg1@@4py0)) arg1@@4py0) :pattern ((FieldType arg0@@10py0 arg1@@4py0)) )) :named A34_0))
(assert (! (forall ((arg0@@8py0 T@T)(arg1@@2py0 T@T)) (! (= (Ctor (FieldType arg0@@8py0 arg1@@2py0)) 10) :pattern ((FieldType arg0@@8py0 arg1@@2py0)) )) :named A34_1))
(assert (! (forall ((arg0@@9py0 T@T)(arg1@@3py0 T@T)) (! (= (FieldTypeInv0 (FieldType arg0@@9py0 arg1@@3py0)) arg0@@9py0) :pattern ((FieldType arg0@@9py0 arg1@@3py0)) )) :named A34_2))
(assert (! (= (ControlFlow 0 0) 6845) :named A35_0))
(assert (! (= (ControlFlow 0 4221) 4225) :named A35_1))
(assert (! (= (ControlFlow 0 6845) 4221) :named A35_2))
(assert (! (= (len a_3@@1) 3) :named A35_3))
(assert (! (= ZeroMask Mask@@9) :named A35_4))
(assert (! (forall ((j_1py0 Int)) (! (or (and (qpRange4 (loc a_3@@1 j_1py0)) (= (invRecv4 (loc a_3@@1 j_1py0)) j_1py0)) (not (<= 0 j_1py0)) (<= FullPerm NoPerm) (<= (len a_3@@1) j_1py0)) :pattern ((loc a_3@@1 j_1py0)) )) :named A35_5))
(assert (! (forall ((j_1@@0py0 Int)) (! (or (not (= (loc a_3@@1 j_1@@0py0) null)) (not (<= 0 j_1@@0py0)) (<= (len a_3@@1) j_1@@0py0)) :pattern ((loc a_3@@1 j_1@@0py0)) )) :named A35_6))
(assert (! (forall ((o_2@@5py0 T@U)) (! (or (= (loc a_3@@1 (invRecv4 o_2@@5py0)) o_2@@5py0) (not (<= 0 (invRecv4 o_2@@5py0))) (not (qpRange4 o_2@@5py0)) (<= FullPerm NoPerm) (<= (len a_3@@1) (invRecv4 o_2@@5py0))) :pattern ((invRecv4 o_2@@5py0)) )) :named A35_7))
(assert (! (forall ((o_2@@6py0 T@U)) (! (and (or (not (<= 0 (invRecv4 o_2@@6py0))) (not (qpRange4 o_2@@6py0)) (<= FullPerm NoPerm) (<= (len a_3@@1) (invRecv4 o_2@@6py0)) (and (or (<= FullPerm NoPerm) (= (loc a_3@@1 (invRecv4 o_2@@6py0)) o_2@@6py0)) (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 o_2@@6py0 val)) (+ (U_2_real (MapType1Select NormalFieldType intType RefType realType ZeroMask o_2@@6py0 val)) FullPerm)))) (or (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 o_2@@6py0 val)) (U_2_real (MapType1Select NormalFieldType intType RefType realType ZeroMask o_2@@6py0 val))) (and (<= 0 (invRecv4 o_2@@6py0)) (not (<= (len a_3@@1) (invRecv4 o_2@@6py0))) (not (<= FullPerm NoPerm)) (qpRange4 o_2@@6py0)))) :pattern ((MapType1Select NormalFieldType intType RefType realType QPMask@0 o_2@@6py0 val)) )) :named A35_8))
(assert (! (forall ((o_2@@7py0 T@U)(f_4@@1py0 T@U)(A@@12py0 T@T)(B@@11py0 T@T)) (! (or (= (U_2_real (MapType1Select A@@12py0 B@@11py0 RefType realType ZeroMask o_2@@7py0 f_4@@1py0)) (U_2_real (MapType1Select A@@12py0 B@@11py0 RefType realType QPMask@0 o_2@@7py0 f_4@@1py0))) (and (= f_4@@1py0 val) (= (FieldType A@@12py0 B@@11py0) (FieldType NormalFieldType intType)))) :pattern ((MapType1Select A@@12py0 B@@11py0 RefType realType ZeroMask o_2@@7py0 f_4@@1py0)) :pattern ((MapType1Select A@@12py0 B@@11py0 RefType realType QPMask@0 o_2@@7py0 f_4@@1py0)) )) :named A35_9))
(assert (! (or (and (= (ControlFlow 0 4225) 4242) (state Heap@@9 QPMask@0) (forall ((i_1_1py0 Int)) (! (or (= (U_2_int (MapType0Select NormalFieldType intType RefType Heap@@9 (loc a_3@@1 i_1_1py0) val)) i_1_1py0) (not (<= 0 i_1_1py0)) (<= (len a_3@@1) i_1_1py0)) :pattern ((loc a_3@@1 i_1_1py0)) )) (or (and (= (ControlFlow 0 4242) (- 7947)) (not (= j_2!50!2 j_2_1!50!1)) (<= 0 j_2!50!2) (not (<= (len a_3@@1) j_2!50!2)) (<= 0 j_2_1!50!1) (not (<= (len a_3@@1) j_2_1!50!1)) (not (<= FullPerm NoPerm)) (= (loc a_3@@1 j_2!50!2) (loc a_3@@1 j_2_1!50!1))) (and (forall ((j_2@@0py0 Int)(j_2_1@@0py0 Int)) (! (or (= j_2@@0py0 j_2_1@@0py0) (not (= (loc a_3@@1 j_2@@0py0) (loc a_3@@1 j_2_1@@0py0))) (not (<= 0 j_2_1@@0py0)) (<= FullPerm NoPerm) (not (<= 0 j_2@@0py0)) (<= (len a_3@@1) j_2_1@@0py0) (<= (len a_3@@1) j_2@@0py0)) :pattern ((neverTriggered5 j_2@@0py0) (neverTriggered5 j_2_1@@0py0)) )) (or (and (= (ControlFlow 0 4242) (- 8189)) (<= 0 j_2@@1!51!3) (not (<= (len a_3@@1) j_2@@1!51!3)) (not (<= FullPerm (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 (loc a_3@@1 j_2@@1!51!3) val))))) (and (forall ((j_2@@2py0 Int)) (! (or (<= FullPerm (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 (loc a_3@@1 j_2@@2py0) val))) (not (<= 0 j_2@@2py0)) (<= (len a_3@@1) j_2@@2py0)) :pattern ((loc a_3@@1 j_2@@2py0)) )) (forall ((j_2@@3py0 Int)) (! (or (and (qpRange5 (loc a_3@@1 j_2@@3py0)) (= (invRecv5 (loc a_3@@1 j_2@@3py0)) j_2@@3py0)) (not (<= 0 j_2@@3py0)) (<= FullPerm NoPerm) (<= (len a_3@@1) j_2@@3py0)) :pattern ((loc a_3@@1 j_2@@3py0)) )) (forall ((o_2py0 T@U)) (! (or (= (loc a_3@@1 (invRecv5 o_2py0)) o_2py0) (<= FullPerm NoPerm) (not (<= 0 (invRecv5 o_2py0))) (not (qpRange5 o_2py0)) (<= (len a_3@@1) (invRecv5 o_2py0))) :pattern ((invRecv5 o_2py0)) )) (forall ((o_2@@0py0 T@U)) (! (and (or (<= FullPerm NoPerm) (not (<= 0 (invRecv5 o_2@@0py0))) (not (qpRange5 o_2@@0py0)) (<= (len a_3@@1) (invRecv5 o_2@@0py0)) (and (= (loc a_3@@1 (invRecv5 o_2@@0py0)) o_2@@0py0) (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@1 o_2@@0py0 val)) (+ (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 o_2@@0py0 val)) (* (- 1.0) FullPerm))))) (or (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@1 o_2@@0py0 val)) (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@0 o_2@@0py0 val))) (and (<= 0 (invRecv5 o_2@@0py0)) (not (<= (len a_3@@1) (invRecv5 o_2@@0py0))) (not (<= FullPerm NoPerm)) (qpRange5 o_2@@0py0)))) :pattern ((MapType1Select NormalFieldType intType RefType realType QPMask@1 o_2@@0py0 val)) )) (forall ((o_2@@1py0 T@U)(f_4py0 T@U)(A@@10py0 T@T)(B@@9py0 T@T)) (! (or (= (U_2_real (MapType1Select A@@10py0 B@@9py0 RefType realType QPMask@0 o_2@@1py0 f_4py0)) (U_2_real (MapType1Select A@@10py0 B@@9py0 RefType realType QPMask@1 o_2@@1py0 f_4py0))) (and (= f_4py0 val) (= (FieldType A@@10py0 B@@9py0) (FieldType NormalFieldType intType)))) :pattern ((MapType1Select A@@10py0 B@@9py0 RefType realType QPMask@1 o_2@@1py0 f_4py0)) )) (IdenticalOnKnownLocations Heap@@9 ExhaleHeap@0 QPMask@1) (forall ((j$0py0 Int)) (! (or (and (qpRange6 (loc a_3@@1 j$0py0)) (= (invRecv6 (loc a_3@@1 j$0py0)) j$0py0)) (not (<= 0 j$0py0)) (<= FullPerm NoPerm) (<= (len a_3@@1) j$0py0)) :pattern ((loc a_3@@1 j$0py0)) )) (forall ((o_2@@2py0 T@U)) (! (or (= (loc a_3@@1 (invRecv6 o_2@@2py0)) o_2@@2py0) (<= FullPerm NoPerm) (not (<= 0 (invRecv6 o_2@@2py0))) (not (qpRange6 o_2@@2py0)) (<= (len a_3@@1) (invRecv6 o_2@@2py0))) :pattern ((invRecv6 o_2@@2py0)) )) (forall ((j$0@@0py0 Int)) (! (or (not (= (loc a_3@@1 j$0@@0py0) null)) (not (<= 0 j$0@@0py0)) (<= (len a_3@@1) j$0@@0py0)) :pattern ((loc a_3@@1 j$0@@0py0)) )) (forall ((o_2@@3py0 T@U)) (! (and (or (<= FullPerm NoPerm) (not (<= 0 (invRecv6 o_2@@3py0))) (not (qpRange6 o_2@@3py0)) (<= (len a_3@@1) (invRecv6 o_2@@3py0)) (and (or (<= FullPerm NoPerm) (= (loc a_3@@1 (invRecv6 o_2@@3py0)) o_2@@3py0)) (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@2 o_2@@3py0 val)) (+ (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@1 o_2@@3py0 val)) FullPerm)))) (or (= (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@2 o_2@@3py0 val)) (U_2_real (MapType1Select NormalFieldType intType RefType realType QPMask@1 o_2@@3py0 val))) (and (<= 0 (invRecv6 o_2@@3py0)) (not (<= (len a_3@@1) (invRecv6 o_2@@3py0))) (not (<= FullPerm NoPerm)) (qpRange6 o_2@@3py0)))) :pattern ((MapType1Select NormalFieldType intType RefType realType QPMask@2 o_2@@3py0 val)) )) (forall ((o_2@@4py0 T@U)(f_4@@0py0 T@U)(A@@11py0 T@T)(B@@10py0 T@T)) (! (or (= (U_2_real (MapType1Select A@@11py0 B@@10py0 RefType realType QPMask@1 o_2@@4py0 f_4@@0py0)) (U_2_real (MapType1Select A@@11py0 B@@10py0 RefType realType QPMask@2 o_2@@4py0 f_4@@0py0))) (and (= f_4@@0py0 val) (= (FieldType A@@11py0 B@@10py0) (FieldType NormalFieldType intType)))) :pattern ((MapType1Select A@@11py0 B@@10py0 RefType realType QPMask@1 o_2@@4py0 f_4@@0py0)) :pattern ((MapType1Select A@@11py0 B@@10py0 RefType realType QPMask@2 o_2@@4py0 f_4@@0py0)) )) (state ExhaleHeap@0 QPMask@2) (forall ((j$1_3py0 Int)) (! (or (= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 j$1_3py0) val)) (U_2_int (MapType0Select NormalFieldType intType RefType Heap@@9 (loc a_3@@1 j$1_3py0) val))) (not (<= 0 j$1_3py0)) (<= (len a_3@@1) j$1_3py0)) :pattern ((loc a_3@@1 j$1_3py0)) )) (or (and (= (ControlFlow 0 4242) 4251) (= (len a_3@@1) 0) (= x@0 (- 1)) (= (ControlFlow 0 4251) 4255) (forall ((j$2_3py0 Int)) (! (or (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 j$2_3py0) val)) (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 x@0) val))) (not (<= 0 j$2_3py0)) (<= (len a_3@@1) j$2_3py0)) :pattern ((loc a_3@@1 j$2_3py0)) )) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 9980)) (not (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 0) val))) (and (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 0) val) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10023)) (not (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 0) val)) x@0))) (and (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 0) val)) x@0) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10063)) (not (= x@0 2))) (and (= x@0 2) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10081)) (not (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 1) val))) (and (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 1) val) (state ExhaleHeap@0 QPMask@2) (= (ControlFlow 0 4255) (- 10109)) (<= x@0 (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 1) val)))))))))))) (and (= (ControlFlow 0 4242) 4253) (not (= (len a_3@@1) 0)) (<= 0 x@0) (not (<= (len a_3@@1) x@0)) (= (ControlFlow 0 4253) 4255) (forall ((j$2_3py0 Int)) (! (or (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 j$2_3py0) val)) (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 x@0) val))) (not (<= 0 j$2_3py0)) (<= (len a_3@@1) j$2_3py0)) :pattern ((loc a_3@@1 j$2_3py0)) )) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 9980)) (not (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 0) val))) (and (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 0) val) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10023)) (not (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 0) val)) x@0))) (and (<= (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 0) val)) x@0) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10063)) (not (= x@0 2))) (and (= x@0 2) (state ExhaleHeap@0 QPMask@2) (or (and (= (ControlFlow 0 4255) (- 10081)) (not (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 1) val))) (and (HasDirectPerm NormalFieldType intType QPMask@2 (loc a_3@@1 1) val) (state ExhaleHeap@0 QPMask@2) (= (ControlFlow 0 4255) (- 10109)) (<= x@0 (U_2_int (MapType0Select NormalFieldType intType RefType ExhaleHeap@0 (loc a_3@@1 1) val)))))))))))))))))) (and (= (ControlFlow 0 4225) 4236) (<= 0 i_2) (not (<= (len a_3@@1) i_2)) (= (ControlFlow 0 4236) (- 10193)) (not (HasDirectPerm NormalFieldType intType QPMask@0 (loc a_3@@1 i_2) val)))) :named A35_10))
(assert (! (state Heap@@9 QPMask@0) :named A35_11))
(assert (! (state Heap@@9 ZeroMask) :named A35_12))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 smt-inputs/benchmarks/verifiers/viper/pattern_augmenter/ematching/tmp/b7.vpr-typeEncoding-a.1_std_unique_aug-gt_unsat-full.smt2
;unknown
