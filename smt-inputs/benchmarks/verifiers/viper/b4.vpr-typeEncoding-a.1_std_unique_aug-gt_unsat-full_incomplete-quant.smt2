...
(set-info :boogie-vc-id benchmark4_1)
...
(declare-fun zip (T@U T@U T@U) T@U)
(declare-fun |zip@quote@| (T@U T@U T@U) T@U)
(declare-fun dummyFunction (T@T T@U) Bool)
(declare-fun SeqType (T@T) T@T)
(declare-fun |zip@sharp@triggerStateless| (T@U T@U) T@U)
(declare-fun SeqTypeInv0 (T@T) T@T)
(declare-fun AssumeFunctionsAbove () Int)
(declare-fun |zip@sharp@frame| (T@U T@U T@U) T@U)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun xs@@3 () T@U)
(declare-fun ys@@3 () T@U)
(declare-fun x@@11 () T@U)
(declare-fun y@@2 () T@U)
(declare-fun Heap@@13 () T@U)
(declare-fun Mask@@11 () T@U)
(declare-fun PostHeap@0 () T@U)
(declare-fun z3name!0 (T@U Real) T@U)
(declare-fun z3name!1 (T@U T@U T@U) T@U)
...
(assert (! (forall ((spy0 T@U)(Tpy0 T@T)) (! (<= 0 (Seq@sharp@Length Tpy0 spy0)) :pattern ((Seq@sharp@Length Tpy0 spy0)) )) :named A29))
(assert (! (forall ((T@@0py0 T@T)) (! (= (Seq@sharp@Length T@@0py0 (Seq@sharp@Empty T@@0py0)) 0) :pattern ((Seq@sharp@Empty T@@0py0)) )) :named A30))
(assert (! (forall ((s@@0py0 T@U)(T@@1py0 T@T)) (! (or (not (= (Seq@sharp@Length T@@1py0 s@@0py0) 0)) (= s@@0py0 (Seq@sharp@Empty T@@1py0))) :pattern ((Seq@sharp@Length T@@1py0 s@@0py0)) )) :named A31))
(assert (! (forall ((tpy0 T@U)(T@@2py0 T@T)) (! (= (Seq@sharp@Length T@@2py0 (Seq@sharp@Singleton T@@2py0 tpy0)) 1) :pattern ((Seq@sharp@Singleton T@@2py0 tpy0)) )) :named A32))
(assert (! (forall ((s0@@7py0 T@U)(s1@@7py0 T@U)(T@@3py0 T@T)) (! (or (= s1@@7py0 (Seq@sharp@Empty T@@3py0)) (= s0@@7py0 (Seq@sharp@Empty T@@3py0)) (= (Seq@sharp@Length T@@3py0 (Seq@sharp@Append T@@3py0 s0@@7py0 s1@@7py0)) (+ (Seq@sharp@Length T@@3py0 s0@@7py0) (Seq@sharp@Length T@@3py0 s1@@7py0)))) :pattern ((Seq@sharp@Length T@@3py0 (Seq@sharp@Append T@@3py0 s0@@7py0 s1@@7py0))) )) :named A33))
(assert (! (forall ((s0@@8py0 T@U)(s1@@8py0 T@U)(T@@4py0 T@T)) (! (and (or (not (= s0@@8py0 (Seq@sharp@Empty T@@4py0))) (= (Seq@sharp@Append T@@4py0 s0@@8py0 s1@@8py0) s1@@8py0)) (or (not (= s1@@8py0 (Seq@sharp@Empty T@@4py0))) (= (Seq@sharp@Append T@@4py0 s0@@8py0 s1@@8py0) s0@@8py0))) :pattern ((Seq@sharp@Append T@@4py0 s0@@8py0 s1@@8py0)) )) :named A34))
(assert (! (forall ((t@@0py0 T@U)(T@@5py0 T@T)) (! (= (Seq@sharp@Index T@@5py0 (Seq@sharp@Singleton T@@5py0 t@@0py0) 0) t@@0py0) :pattern ((Seq@sharp@Singleton T@@5py0 t@@0py0)) )) :named A35))
(assert (! (forall ((ipy0 Int)(jpy0 Int)) (! (= (Seq@sharp@Add ipy0 jpy0) (+ ipy0 jpy0)) :pattern ((Seq@sharp@Add ipy0 jpy0)) )) :named A36))
(assert (! (forall ((i@@0py0 Int)(j@@0py0 Int)) (! (= (Seq@sharp@Sub i@@0py0 j@@0py0) (+ i@@0py0 (* (- 1) j@@0py0))) :pattern ((Seq@sharp@Sub i@@0py0 j@@0py0)) )) :named A37))
(assert (! (forall ((s0@@9py0 T@U)(s1@@9py0 T@U)(npy0 Int)(T@@6py0 T@T)) (! (or (= s1@@9py0 (Seq@sharp@Empty T@@6py0)) (= s0@@9py0 (Seq@sharp@Empty T@@6py0)) (= (Seq@sharp@Index T@@6py0 (Seq@sharp@Append T@@6py0 s0@@9py0 s1@@9py0) npy0) (Seq@sharp@Index T@@6py0 s0@@9py0 npy0)) (not (<= 0 npy0)) (<= (Seq@sharp@Length T@@6py0 s0@@9py0) npy0)) :pattern ((Seq@sharp@Index T@@6py0 (Seq@sharp@Append T@@6py0 s0@@9py0 s1@@9py0) npy0)) :pattern ((Seq@sharp@Index T@@6py0 s0@@9py0 npy0) (Seq@sharp@Append T@@6py0 s0@@9py0 s1@@9py0)) )) :named A38))
(assert (! (forall ((s0@@10py0 T@U)(s1@@10py0 T@U)(n@@0py0 Int)(T@@7py0 T@T)) (! (or (= s1@@10py0 (Seq@sharp@Empty T@@7py0)) (= s0@@10py0 (Seq@sharp@Empty T@@7py0)) (and (= (Seq@sharp@Add (Seq@sharp@Sub n@@0py0 (Seq@sharp@Length T@@7py0 s0@@10py0)) (Seq@sharp@Length T@@7py0 s0@@10py0)) n@@0py0) (= (Seq@sharp@Index T@@7py0 (Seq@sharp@Append T@@7py0 s0@@10py0 s1@@10py0) n@@0py0) (Seq@sharp@Index T@@7py0 s1@@10py0 (Seq@sharp@Sub n@@0py0 (Seq@sharp@Length T@@7py0 s0@@10py0))))) (not (<= (Seq@sharp@Length T@@7py0 s0@@10py0) n@@0py0)) (<= (Seq@sharp@Length T@@7py0 (Seq@sharp@Append T@@7py0 s0@@10py0 s1@@10py0)) n@@0py0)) :pattern ((Seq@sharp@Index T@@7py0 (Seq@sharp@Append T@@7py0 s0@@10py0 s1@@10py0) n@@0py0)) )) :named A39))
(assert (! (forall ((s0@@11py0 T@U)(s1@@11py0 T@U)(m@@9py0 Int)(T@@8py0 T@T)) (! (or (= s1@@11py0 (Seq@sharp@Empty T@@8py0)) (= s0@@11py0 (Seq@sharp@Empty T@@8py0)) (and (= (Seq@sharp@Sub (Seq@sharp@Add m@@9py0 (Seq@sharp@Length T@@8py0 s0@@11py0)) (Seq@sharp@Length T@@8py0 s0@@11py0)) m@@9py0) (= (Seq@sharp@Index T@@8py0 (Seq@sharp@Append T@@8py0 s0@@11py0 s1@@11py0) (Seq@sharp@Add m@@9py0 (Seq@sharp@Length T@@8py0 s0@@11py0))) (Seq@sharp@Index T@@8py0 s1@@11py0 m@@9py0))) (not (<= 0 m@@9py0)) (<= (Seq@sharp@Length T@@8py0 s1@@11py0) m@@9py0)) :pattern ((Seq@sharp@Index T@@8py0 s1@@11py0 m@@9py0) (Seq@sharp@Append T@@8py0 s0@@11py0 s1@@11py0)) )) :named A40))
(assert (! (forall ((s@@1py0 T@U)(i@@1py0 Int)(v@@0py0 T@U)(T@@9py0 T@T)) (! (or (not (<= 0 i@@1py0)) (<= (Seq@sharp@Length T@@9py0 s@@1py0) i@@1py0) (= (Seq@sharp@Length T@@9py0 (Seq@sharp@Update T@@9py0 s@@1py0 i@@1py0 v@@0py0)) (Seq@sharp@Length T@@9py0 s@@1py0))) :pattern ((Seq@sharp@Length T@@9py0 (Seq@sharp@Update T@@9py0 s@@1py0 i@@1py0 v@@0py0))) :pattern ((Seq@sharp@Length T@@9py0 s@@1py0) (Seq@sharp@Update T@@9py0 s@@1py0 i@@1py0 v@@0py0)) )) :named A41))
(assert (! (forall ((s@@2py0 T@U)(i@@2py0 Int)(v@@1py0 T@U)(n@@1py0 Int)(T@@10py0 T@T)) (! (or (not (<= 0 n@@1py0)) (<= (Seq@sharp@Length T@@10py0 s@@2py0) n@@1py0) (and (or (not (= i@@2py0 n@@1py0)) (= (Seq@sharp@Index T@@10py0 (Seq@sharp@Update T@@10py0 s@@2py0 i@@2py0 v@@1py0) n@@1py0) v@@1py0)) (or (= i@@2py0 n@@1py0) (= (Seq@sharp@Index T@@10py0 (Seq@sharp@Update T@@10py0 s@@2py0 i@@2py0 v@@1py0) n@@1py0) (Seq@sharp@Index T@@10py0 s@@2py0 n@@1py0))))) :pattern ((Seq@sharp@Index T@@10py0 (Seq@sharp@Update T@@10py0 s@@2py0 i@@2py0 v@@1py0) n@@1py0)) :pattern ((Seq@sharp@Index T@@10py0 s@@2py0 n@@1py0) (Seq@sharp@Update T@@10py0 s@@2py0 i@@2py0 v@@1py0)) )) :named A42))
(assert (! (forall ((s@@3py0 T@U)(n@@2py0 Int)(T@@11py0 T@T)) (! (and (or (not (<= 0 n@@2py0)) (and (or (not (<= n@@2py0 (Seq@sharp@Length T@@11py0 s@@3py0))) (= (Seq@sharp@Length T@@11py0 (Seq@sharp@Take T@@11py0 s@@3py0 n@@2py0)) n@@2py0)) (or (<= n@@2py0 (Seq@sharp@Length T@@11py0 s@@3py0)) (= (Seq@sharp@Length T@@11py0 (Seq@sharp@Take T@@11py0 s@@3py0 n@@2py0)) (Seq@sharp@Length T@@11py0 s@@3py0))))) (or (<= 0 n@@2py0) (= (Seq@sharp@Length T@@11py0 (Seq@sharp@Take T@@11py0 s@@3py0 n@@2py0)) 0))) :pattern ((Seq@sharp@Length T@@11py0 (Seq@sharp@Take T@@11py0 s@@3py0 n@@2py0))) :pattern ((Seq@sharp@Take T@@11py0 s@@3py0 n@@2py0) (Seq@sharp@Length T@@11py0 s@@3py0)) )) :named A43))
(assert (! (forall ((s@@4py0 T@U)(n@@3py0 Int)(j@@1py0 Int)(T@@12py0 T@T)) (! (or (not (<= 0 j@@1py0)) (<= n@@3py0 j@@1py0) (<= (Seq@sharp@Length T@@12py0 s@@4py0) j@@1py0) (= (Seq@sharp@Index T@@12py0 (Seq@sharp@Take T@@12py0 s@@4py0 n@@3py0) j@@1py0) (Seq@sharp@Index T@@12py0 s@@4py0 j@@1py0))) :pattern ((Seq@sharp@Index T@@12py0 (Seq@sharp@Take T@@12py0 s@@4py0 n@@3py0) j@@1py0)) :pattern ((Seq@sharp@Index T@@12py0 s@@4py0 j@@1py0) (Seq@sharp@Take T@@12py0 s@@4py0 n@@3py0)) )) :named A44))
(assert (! (forall ((s@@5py0 T@U)(n@@4py0 Int)(T@@13py0 T@T)) (! (and (or (not (<= 0 n@@4py0)) (and (or (not (<= n@@4py0 (Seq@sharp@Length T@@13py0 s@@5py0))) (= (Seq@sharp@Length T@@13py0 (Seq@sharp@Drop T@@13py0 s@@5py0 n@@4py0)) (+ (Seq@sharp@Length T@@13py0 s@@5py0) (* (- 1) n@@4py0)))) (or (<= n@@4py0 (Seq@sharp@Length T@@13py0 s@@5py0)) (= (Seq@sharp@Length T@@13py0 (Seq@sharp@Drop T@@13py0 s@@5py0 n@@4py0)) 0)))) (or (<= 0 n@@4py0) (= (Seq@sharp@Length T@@13py0 (Seq@sharp@Drop T@@13py0 s@@5py0 n@@4py0)) (Seq@sharp@Length T@@13py0 s@@5py0)))) :pattern ((Seq@sharp@Length T@@13py0 (Seq@sharp@Drop T@@13py0 s@@5py0 n@@4py0))) :pattern ((Seq@sharp@Length T@@13py0 s@@5py0) (Seq@sharp@Drop T@@13py0 s@@5py0 n@@4py0)) )) :named A45))
(assert (! (forall ((s@@6py0 T@U)(n@@5py0 Int)(j@@2py0 Int)(T@@14py0 T@T)) (! (or (and (= (Seq@sharp@Sub (Seq@sharp@Add j@@2py0 n@@5py0) n@@5py0) j@@2py0) (= (Seq@sharp@Index T@@14py0 (Seq@sharp@Drop T@@14py0 s@@6py0 n@@5py0) j@@2py0) (Seq@sharp@Index T@@14py0 s@@6py0 (Seq@sharp@Add j@@2py0 n@@5py0)))) (<= n@@5py0 0) (not (<= 0 j@@2py0)) (<= (+ (Seq@sharp@Length T@@14py0 s@@6py0) (* (- 1) n@@5py0)) j@@2py0)) :pattern ((Seq@sharp@Index T@@14py0 (Seq@sharp@Drop T@@14py0 s@@6py0 n@@5py0) j@@2py0)) )) :named A46))
(assert (! (forall ((s@@7py0 T@U)(n@@6py0 Int)(i@@3py0 Int)(T@@15py0 T@T)) (! (or (<= (Seq@sharp@Length T@@15py0 s@@7py0) i@@3py0) (and (= (Seq@sharp@Add (Seq@sharp@Sub i@@3py0 n@@6py0) n@@6py0) i@@3py0) (= (Seq@sharp@Index T@@15py0 (Seq@sharp@Drop T@@15py0 s@@7py0 n@@6py0) (Seq@sharp@Sub i@@3py0 n@@6py0)) (Seq@sharp@Index T@@15py0 s@@7py0 i@@3py0))) (<= n@@6py0 0) (not (<= n@@6py0 i@@3py0))) :pattern ((Seq@sharp@Drop T@@15py0 s@@7py0 n@@6py0) (Seq@sharp@Index T@@15py0 s@@7py0 i@@3py0)) )) :named A47))
...
(assert (! (forall ((s@@9py0 T@U)(t@@2py0 T@U)(n@@8py0 Int)(T@@17py0 T@T)) (! (or (<= n@@8py0 0) (<= n@@8py0 (Seq@sharp@Length T@@17py0 s@@9py0)) (and (= (Seq@sharp@Add (Seq@sharp@Sub n@@8py0 (Seq@sharp@Length T@@17py0 s@@9py0)) (Seq@sharp@Length T@@17py0 s@@9py0)) n@@8py0) (= (Seq@sharp@Take T@@17py0 (Seq@sharp@Append T@@17py0 s@@9py0 t@@2py0) n@@8py0) (Seq@sharp@Append T@@17py0 s@@9py0 (Seq@sharp@Take T@@17py0 t@@2py0 (Seq@sharp@Sub n@@8py0 (Seq@sharp@Length T@@17py0 s@@9py0))))))) :pattern ((Seq@sharp@Take T@@17py0 (Seq@sharp@Append T@@17py0 s@@9py0 t@@2py0) n@@8py0)) )) :named A49))
(assert (! (forall ((s@@10py0 T@U)(t@@3py0 T@U)(n@@9py0 Int)(T@@18py0 T@T)) (! (or (= (Seq@sharp@Drop T@@18py0 (Seq@sharp@Append T@@18py0 s@@10py0 t@@3py0) n@@9py0) (Seq@sharp@Append T@@18py0 (Seq@sharp@Drop T@@18py0 s@@10py0 n@@9py0) t@@3py0)) (<= n@@9py0 0) (not (<= n@@9py0 (Seq@sharp@Length T@@18py0 s@@10py0)))) :pattern ((Seq@sharp@Drop T@@18py0 (Seq@sharp@Append T@@18py0 s@@10py0 t@@3py0) n@@9py0)) )) :named A50))
(assert (! (forall ((s@@11py0 T@U)(t@@4py0 T@U)(n@@10py0 Int)(T@@19py0 T@T)) (! (or (<= n@@10py0 0) (<= n@@10py0 (Seq@sharp@Length T@@19py0 s@@11py0)) (and (= (Seq@sharp@Add (Seq@sharp@Sub n@@10py0 (Seq@sharp@Length T@@19py0 s@@11py0)) (Seq@sharp@Length T@@19py0 s@@11py0)) n@@10py0) (= (Seq@sharp@Drop T@@19py0 (Seq@sharp@Append T@@19py0 s@@11py0 t@@4py0) n@@10py0) (Seq@sharp@Drop T@@19py0 t@@4py0 (Seq@sharp@Sub n@@10py0 (Seq@sharp@Length T@@19py0 s@@11py0)))))) :pattern ((Seq@sharp@Drop T@@19py0 (Seq@sharp@Append T@@19py0 s@@11py0 t@@4py0) n@@10py0)) )) :named A51))
(assert (! (forall ((s@@12py0 T@U)(n@@11py0 Int)(T@@20py0 T@T)) (! (or (not (<= n@@11py0 0)) (= (Seq@sharp@Drop T@@20py0 s@@12py0 n@@11py0) s@@12py0)) :pattern ((Seq@sharp@Drop T@@20py0 s@@12py0 n@@11py0)) )) :named A52))
(assert (! (forall ((s@@13py0 T@U)(n@@12py0 Int)(T@@21py0 T@T)) (! (or (not (<= n@@12py0 0)) (= (Seq@sharp@Take T@@21py0 s@@13py0 n@@12py0) (Seq@sharp@Empty T@@21py0))) :pattern ((Seq@sharp@Take T@@21py0 s@@13py0 n@@12py0)) )) :named A53))
(assert (! (forall ((s@@14py0 T@U)(x@@8py0 T@U)(T@@22py0 T@T)) (! (or (not (Seq@sharp@Contains T@@22py0 s@@14py0 x@@8py0)) (and (<= 0 (Seq@sharp@Skolem T@@22py0 s@@14py0 x@@8py0)) (not (<= (Seq@sharp@Length T@@22py0 s@@14py0) (Seq@sharp@Skolem T@@22py0 s@@14py0 x@@8py0))) (= (Seq@sharp@Index T@@22py0 s@@14py0 (Seq@sharp@Skolem T@@22py0 s@@14py0 x@@8py0)) x@@8py0))) :pattern ((Seq@sharp@Contains T@@22py0 s@@14py0 x@@8py0)) )) :named A54))
(assert (! (forall ((s@@15py0 T@U)(x@@9py0 T@U)(i@@4py0 Int)(T@@23py0 T@T)) (! (or (<= (Seq@sharp@Length T@@23py0 s@@15py0) i@@4py0) (Seq@sharp@Contains T@@23py0 s@@15py0 x@@9py0) (not (<= 0 i@@4py0)) (not (= (Seq@sharp@Index T@@23py0 s@@15py0 i@@4py0) x@@9py0))) :pattern ((Seq@sharp@Contains T@@23py0 s@@15py0 x@@9py0) (Seq@sharp@Index T@@23py0 s@@15py0 i@@4py0)) )) :named A55))
(assert (! (forall ((s@@16py0 T@U)(i@@5py0 Int)(T@@24py0 T@T)) (! (or (not (<= 0 i@@5py0)) (<= (Seq@sharp@Length T@@24py0 s@@16py0) i@@5py0) (Seq@sharp@ContainsTrigger T@@24py0 s@@16py0 (Seq@sharp@Index T@@24py0 s@@16py0 i@@5py0))) :pattern ((Seq@sharp@Index T@@24py0 s@@16py0 i@@5py0)) )) :named A56))
(assert (! (forall ((s0@@12py0 T@U)(s1@@12py0 T@U)(T@@25py0 T@T)) (! (or (not (Seq@sharp@Equal T@@25py0 s0@@12py0 s1@@12py0)) (and (= (Seq@sharp@Length T@@25py0 s0@@12py0) (Seq@sharp@Length T@@25py0 s1@@12py0)) (forall ((j@@3py0 Int)) (! (or (not (<= 0 j@@3py0)) (<= (Seq@sharp@Length T@@25py0 s0@@12py0) j@@3py0) (= (Seq@sharp@Index T@@25py0 s0@@12py0 j@@3py0) (Seq@sharp@Index T@@25py0 s1@@12py0 j@@3py0))) :pattern ((Seq@sharp@Index T@@25py0 s0@@12py0 j@@3py0)) :pattern ((Seq@sharp@Index T@@25py0 s1@@12py0 j@@3py0)) )))) :pattern ((Seq@sharp@Equal T@@25py0 s0@@12py0 s1@@12py0)) )) :named A57))
...
(assert (! (forall ((apy0 T@U)(bpy0 T@U)(T@@27py0 T@T)) (! (or (not (Seq@sharp@Equal T@@27py0 apy0 bpy0)) (= apy0 bpy0)) :pattern ((Seq@sharp@Equal T@@27py0 apy0 bpy0)) )) :named A59))
(assert (! (forall ((x@@10py0 T@U)(y@@1py0 T@U)(T@@28py0 T@T)) (! (and (or (not (Seq@sharp@Contains T@@28py0 (Seq@sharp@Singleton T@@28py0 x@@10py0) y@@1py0)) (= x@@10py0 y@@1py0)) (or (not (= x@@10py0 y@@1py0)) (Seq@sharp@Contains T@@28py0 (Seq@sharp@Singleton T@@28py0 x@@10py0) y@@1py0))) :pattern ((Seq@sharp@Contains T@@28py0 (Seq@sharp@Singleton T@@28py0 x@@10py0) y@@1py0)) )) :named A60))
(assert (! (forall ((q@minpy0 Int)(q@maxpy0 Int)) (! (and (or (<= q@maxpy0 q@minpy0) (= (Seq@sharp@Length intType (Seq@sharp@Range q@minpy0 q@maxpy0)) (+ q@maxpy0 (* (- 1) q@minpy0)))) (or (not (<= q@maxpy0 q@minpy0)) (= (Seq@sharp@Length intType (Seq@sharp@Range q@minpy0 q@maxpy0)) 0))) :pattern ((Seq@sharp@Length intType (Seq@sharp@Range q@minpy0 q@maxpy0))) )) :named A61))
(assert (! (forall ((q@min@@0py0 Int)(q@max@@0py0 Int)(j@@4py0 Int)) (! (or (not (<= 0 j@@4py0)) (<= (+ q@max@@0py0 (* (- 1) q@min@@0py0)) j@@4py0) (= (U_2_int (Seq@sharp@Index intType (Seq@sharp@Range q@min@@0py0 q@max@@0py0) j@@4py0)) (+ q@min@@0py0 j@@4py0))) :pattern ((Seq@sharp@Index intType (Seq@sharp@Range q@min@@0py0 q@max@@0py0) j@@4py0)) )) :named A62))
(assert (! (forall ((q@min@@1py0 Int)(q@max@@1py0 Int)(v@@2py0 T@U)) (! (and (or (not (Seq@sharp@Contains intType (Seq@sharp@Range q@min@@1py0 q@max@@1py0) v@@2py0)) (and (<= q@min@@1py0 (U_2_int v@@2py0)) (not (<= q@max@@1py0 (U_2_int v@@2py0))))) (or (Seq@sharp@Contains intType (Seq@sharp@Range q@min@@1py0 q@max@@1py0) v@@2py0) (not (<= q@min@@1py0 (U_2_int v@@2py0))) (<= q@max@@1py0 (U_2_int v@@2py0)))) :pattern ((Seq@sharp@Contains intType (Seq@sharp@Range q@min@@1py0 q@max@@1py0) v@@2py0)) )) :named A63))
(assert (! (forall ((arg0@@8py0 T@T)) (! (= (Ctor (SeqType arg0@@8py0)) 10) :pattern ((SeqType arg0@@8py0)) )) :named A64_0))
(assert (! (forall ((arg0@@9py0 T@T)) (! (= (SeqTypeInv0 (SeqType arg0@@9py0)) arg0@@9py0) :pattern ((SeqType arg0@@9py0)) )) :named A64_1))
(assert (! (forall ((Heap@@9py0 T@U)(xspy0 T@U)(yspy0 T@U)) (! (and (= (zip Heap@@9py0 xspy0 yspy0) (zip@quote@ Heap@@9py0 xspy0 yspy0)) (dummyFunction (SeqType RefType) (zip@sharp@triggerStateless xspy0 yspy0))) :pattern ((zip Heap@@9py0 xspy0 yspy0)) )) :named A65))
(assert (! (forall ((Heap@@10py0 T@U)(xs@@0py0 T@U)(ys@@0py0 T@U)) (! (dummyFunction (SeqType RefType) (zip@sharp@triggerStateless xs@@0py0 ys@@0py0)) :pattern ((zip@quote@ Heap@@10py0 xs@@0py0 ys@@0py0)) )) :named A66))
(assert (! (forall ((Heap@@11py0 T@U)(Mask@@9py0 T@U)(xs@@1py0 T@U)(ys@@1py0 T@U)) (! (or (not (state Heap@@11py0 Mask@@9py0)) (<= 0 AssumeFunctionsAbove) (= (zip Heap@@11py0 xs@@1py0 ys@@1py0) (z3name!1 ys@@1py0 xs@@1py0 Heap@@11py0)) (and (not (= (Seq@sharp@Length RefType xs@@1py0) (Seq@sharp@Length RefType ys@@1py0))) (not (= (Seq@sharp@Length RefType xs@@1py0) (+ 1 (Seq@sharp@Length RefType ys@@1py0)))))) :pattern ((state Heap@@11py0 Mask@@9py0) (zip Heap@@11py0 xs@@1py0 ys@@1py0)) )) :named A67_0))
(assert (! (forall ((x!1py2 T@U)(x!2py2 T@U)(x!3py0 T@U)) (! (or (Seq@sharp@Equal RefType x!3py0 (Seq@sharp@Empty RefType)) (= (z3name!1 x!3py0 x!2py2 x!1py2) (Seq@sharp@Append RefType (Seq@sharp@Append RefType (Seq@sharp@Singleton RefType (Seq@sharp@Index RefType x!2py2 0)) (Seq@sharp@Singleton RefType (Seq@sharp@Index RefType x!3py0 0))) (zip@quote@ x!1py2 (Seq@sharp@Drop RefType x!2py2 1) (Seq@sharp@Drop RefType x!3py0 1))))) :pattern ((z3name!1 x!3py0 x!2py2 x!1py2)) )) :named A67_1))
(assert (! (forall ((x!1py3 T@U)(x!2py3 T@U)(x!3py1 T@U)) (! (or (not (Seq@sharp@Equal RefType x!3py1 (Seq@sharp@Empty RefType))) (= (z3name!1 x!3py1 x!2py3 x!1py3) x!2py3)) :pattern ((z3name!1 x!3py1 x!2py3 x!1py3)) )) :named A67_2))
(assert (! (forall ((Heap@@12py0 T@U)(Mask@@10py0 T@U)(xs@@2py0 T@U)(ys@@2py0 T@U)) (! (or (not (state Heap@@12py0 Mask@@10py0)) (= (zip@quote@ Heap@@12py0 xs@@2py0 ys@@2py0) (zip@sharp@frame EmptyFrame xs@@2py0 ys@@2py0))) :pattern ((state Heap@@12py0 Mask@@10py0) (zip@quote@ Heap@@12py0 xs@@2py0 ys@@2py0)) )) :named A68))
(assert (! (= (ControlFlow 0 0) 6047) :named A69_0))
(assert (! (= (ControlFlow 0 6047) 3650) :named A69_1))
(assert (! (= AssumeFunctionsAbove (- 1)) :named A69_2))
(assert (! (= ZeroMask Mask@@11) :named A69_3))
(assert (! (Seq@sharp@Equal RefType xs@@3 (Seq@sharp@Singleton RefType x@@11)) :named A69_4))
(assert (! (Seq@sharp@Equal RefType ys@@3 (Seq@sharp@Singleton RefType y@@2)) :named A69_5))
(assert (! (U_2_bool (MapType0Select NormalFieldType boolType RefType Heap@@13 x@@11 $allocated)) :named A69_6))
(assert (! (U_2_bool (MapType0Select NormalFieldType boolType RefType Heap@@13 y@@2 $allocated)) :named A69_7))
(assert (! (or (and (= (ControlFlow 0 3650) 3660) (= (ControlFlow 0 3660) (- 6349)) (not (Seq@sharp@Equal RefType (Seq@sharp@Append RefType (Seq@sharp@Singleton RefType x@@11) (Seq@sharp@Singleton RefType y@@2)) (zip Heap@@13 xs@@3 ys@@3)))) (and (= (ControlFlow 0 3650) 3654) (= (ControlFlow 0 3654) (- 6369)) (not (= (Seq@sharp@Length RefType xs@@3) (Seq@sharp@Length RefType ys@@3))) (not (= (Seq@sharp@Length RefType xs@@3) (+ 1 (Seq@sharp@Length RefType ys@@3)))))) :named A69_8))
(assert (! (state Heap@@13 ZeroMask) :named A69_9))
(assert (! (state PostHeap@0 ZeroMask) :named A69_10))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 smt-inputs/benchmarks/verifiers/viper/pattern_augmenter/ematching/tmp/b4.vpr-typeEncoding-a.1_std_unique_aug-gt_unsat-full.smt2
;unknown
