...
(set-info :boogie-vc-id benchmark2)
...
(assert (! (forall ((t0@@9py0 T@T)(t1@@9py0 T@T)(val@@10py0 T@U)(m@@9py0 T@U)(x0@@9py0 T@U)) (! (= (MapType2Select t0@@9py0 t1@@9py0 (MapType2Store t0@@9py0 t1@@9py0 m@@9py0 x0@@9py0 val@@10py0) x0@@9py0) val@@10py0) :pattern ((MapType2Store t0@@9py0 t1@@9py0 m@@9py0 x0@@9py0 val@@10py0)) )) :named A31_0))
(assert (! (forall ((u0@@7py0 T@T)(u1@@3py0 T@T)(val@@11py0 T@U)(m@@10py0 T@U)(x0@@10py0 T@U)(y0@@7py0 T@U)) (! (or (= x0@@10py0 y0@@7py0) (= (MapType2Select u0@@7py0 u1@@3py0 (MapType2Store u0@@7py0 u1@@3py0 m@@10py0 x0@@10py0 val@@11py0) y0@@7py0) (MapType2Select u0@@7py0 u1@@3py0 m@@10py0 y0@@7py0))) :pattern ((MapType2Select u0@@7py0 u1@@3py0 (MapType2Store u0@@7py0 u1@@3py0 m@@10py0 x0@@10py0 val@@11py0) y0@@7py0)) )) :named A31_1))
...
(assert (! (not (IsPredicateField NormalFieldType intType val)) :named A84))
(assert (! (not (IsWandField NormalFieldType intType val)) :named A85))
(assert (! (= (ControlFlow 0 0) 5665) :named A86_0))
(assert (! (= (ControlFlow 0 3273) 3277) :named A86_1))
(assert (! (= (ControlFlow 0 3277) (- 5734)) :named A86_2))
(assert (! (= (ControlFlow 0 5665) 3273) :named A86_3))
(assert (! (= ZeroMask Mask@@9) :named A86_4))
(assert (! (forall ((r_1py0 T@U)) (! (and (or (U_2_bool (MapType2Select RefType boolType B@@9 r_1py0)) (not (U_2_bool (MapType2Select RefType boolType A@@10 r_1py0)))) (or (U_2_bool (MapType2Select RefType boolType A@@10 r_1py0)) (not (U_2_bool (MapType2Select RefType boolType B@@9 r_1py0))))) :pattern ((MapType2Select RefType boolType A@@10 r_1py0)) :pattern ((MapType2Select RefType boolType B@@9 r_1py0)) )) :named A86_5))
(assert (! (not (= (Set@sharp@Card RefType A@@10) (Set@sharp@Card RefType B@@9))) :named A86_6))
(assert (! (state Heap@@9 ZeroMask) :named A86_7))

;(declare-fun dummy (Bool) Bool)
;(assert (dummy (Set@sharp@Equal RefType A@@10 B@@9)))

(check-sat)
(get-info :reason-unknown)
;z3 -T:600 smt-inputs/benchmarks/verifiers/viper/pattern_augmenter/ematching/tmp/b2.vpr-typeEncoding-a_std_unique_aug-gt_unsat-full.smt2
;unknown
