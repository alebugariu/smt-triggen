...
(assert (! (= (ControlFlow 0 0) 5154) :named A42_0))
(assert (! (= (ControlFlow 0 5154) 2740) :named A42_1))
(assert (! (= AssumeFunctionsAbove (- 1)) :named A42_2))
(assert (! (= Mask@0 (MapType1Store PredicateType_Triggersvalid$Type FrameTypeType RefType realType ZeroMask null (Triggersvalid$ this$_7) (real_2_U (+ (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType ZeroMask null (Triggersvalid$ this$_7))) FullPerm)))) :named A42_3))
(assert (! (U_2_bool (MapType0Select NormalFieldType boolType RefType Heap@@16 this$_7 $allocated)) :named A42_4))
(assert (! (not (<= FullPerm k$_1)) :named A42_5))
(assert (! (not (<= k$_1 NoPerm)) :named A42_6))
(assert (! (not (<= wildcard NoPerm)) :named A42_7))
(assert (! (not (= this$_7 null)) :named A42_8))
(assert (! (or (and (= (ControlFlow 0 2740) 2767) (state Heap@@16 Mask@0) (forall ((a_1_1py0 Int)(b_1_1py0 Int)(c_1py0 Int)) (! (and (Triggersg$ Heap@@16 this$_7 a_1_1py0) (Triggersf$ Heap@@16 this$_7 a_1_1py0 b_1_1py0 c_1py0)) :pattern ((Triggersg$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType Heap@@16 null (Triggersvalid$ this$_7)) this$_7 a_1_1py0) (Triggersf$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType Heap@@16 null (Triggersvalid$ this$_7)) this$_7 a_1_1py0 b_1_1py0 c_1py0)) :pattern ((Triggersf$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType Heap@@16 null (Triggersvalid$ this$_7)) this$_7 a_1_1py0 b_1_1py0 c_1py0)) )) (= Mask@0 Mask@@11) (state PostHeap@0 ZeroMask) (or (and (= (ControlFlow 0 2767) 2771) (= PostMask@0 (MapType1Store PredicateType_Triggersvalid$Type FrameTypeType RefType realType ZeroMask null (Triggersvalid$ this$_7) (real_2_U (+ (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType ZeroMask null (Triggersvalid$ this$_7))) FullPerm)))) (state PostHeap@0 PostMask@0) (or (and (= (ControlFlow 0 2771) 2781) (state PostHeap@0 PostMask@0) (forall ((x_1py0 Int)(y_1py0 Int)(z_1py0 Int)) (! (Triggersf$ PostHeap@0 this$_7 x_1py0 y_1py0 z_1py0) :pattern ((Triggersf$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType PostHeap@0 null (Triggersvalid$ this$_7)) this$_7 x_1py0 y_1py0 z_1py0)) )) (= (ControlFlow 0 2781) 2787) (or (and (= (ControlFlow 0 2787) (- 5947)) (= this$_7 null)) (and (not (= this$_7 null)) (not (<= wildcard@0 NoPerm)) (= perm@1 (+ NoPerm wildcard@0)) (= (ControlFlow 0 2787) (- 5974)) (<= (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType PostMask@0 null (Triggersvalid$ this$_7))) NoPerm)))) (and (= (ControlFlow 0 2771) 2775) (or (and (= (ControlFlow 0 2775) (- 6041)) (= this$_7 null)) (and (not (= this$_7 null)) (not (<= wildcard@1 NoPerm)) (= perm@2 (+ NoPerm wildcard@1)) (= (ControlFlow 0 2775) (- 6068)) (<= (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType PostMask@0 null (Triggersvalid$ this$_7))) NoPerm)))))) (and (= (ControlFlow 0 2767) 2797) (U_2_bool (MapType0Select NormalFieldType boolType RefType Heap@@16 n$_1 $allocated)) (= perm@0 (+ NoPerm FullPerm)) (or (and (= (ControlFlow 0 2797) 2806) (not (= perm@0 NoPerm)) (or (and (= (ControlFlow 0 2806) (- 5717)) (not (<= perm@0 (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7)))))) (and (<= perm@0 (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7)))) (= (ControlFlow 0 2806) 2810) (= Mask@1 (MapType1Store PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7) (real_2_U (+ (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7))) (* (- 1.0) perm@0))))) (or (and (= (ControlFlow 0 2810) 2812) (= (ControlFlow 0 2812) (- 5762)) (not (Triggersf$ Heap@@16 this$_7 x_2 y_2 z_2))) (and (= (ControlFlow 0 2810) 2814) (forall ((x_3_1py0 Int)(y_3_1py0 Int)(z_3_1py0 Int)) (! (Triggersf$ Heap@@16 this$_7 x_3_1py0 y_3_1py0 z_3_1py0) :pattern ((Triggersf$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType Heap@@16 null (Triggersvalid$ this$_7)) this$_7 x_3_1py0 y_3_1py0 z_3_1py0)) )) (= (ControlFlow 0 2814) 2818) (= (ControlFlow 0 2818) (- 5812)) (not (Triggersg$ Heap@@16 this$_7 w_2))))))) (and (= (ControlFlow 0 2797) 2808) (= perm@0 NoPerm) (= (ControlFlow 0 2808) 2810) (= Mask@1 (MapType1Store PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7) (real_2_U (+ (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7))) (* (- 1.0) perm@0))))) (or (and (= (ControlFlow 0 2810) 2812) (= (ControlFlow 0 2812) (- 5762)) (not (Triggersf$ Heap@@16 this$_7 x_2 y_2 z_2))) (and (= (ControlFlow 0 2810) 2814) (forall ((x_3_1py1 Int)(y_3_1py1 Int)(z_3_1py1 Int)) (! (Triggersf$ Heap@@16 this$_7 x_3_1py1 y_3_1py1 z_3_1py1) :pattern ((Triggersf$@sharp@frame (MapType0Select PredicateType_Triggersvalid$Type FrameTypeType RefType Heap@@16 null (Triggersvalid$ this$_7)) this$_7 x_3_1py1 y_3_1py1 z_3_1py1)) )) (= (ControlFlow 0 2814) 2818) (= (ControlFlow 0 2818) (- 5812)) (not (Triggersg$ Heap@@16 this$_7 w_2))))))))) (and (= (ControlFlow 0 2740) 2744) (or (and (= (ControlFlow 0 2744) (- 6135)) (= this$_7 null)) (and (not (= this$_7 null)) (not (<= wildcard@2 NoPerm)) (= perm@3 (+ NoPerm wildcard@2)) (= (ControlFlow 0 2744) (- 6162)) (<= (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7))) NoPerm)))) (and (= (ControlFlow 0 2740) 2757) (Triggersg$ Heap@@16 this$_7 a_2) (= (ControlFlow 0 2757) 2759) (or (and (= (ControlFlow 0 2759) (- 6246)) (= this$_7 null)) (and (not (= this$_7 null)) (not (<= wildcard@3 NoPerm)) (= perm@4 (+ NoPerm wildcard@3)) (= (ControlFlow 0 2759) (- 6273)) (<= (U_2_real (MapType1Select PredicateType_Triggersvalid$Type FrameTypeType RefType realType Mask@0 null (Triggersvalid$ this$_7))) NoPerm))))) :named A42_9))
(assert (! (state Heap@@16 Mask@0) :named A42_10))
(assert (! (state Heap@@16 ZeroMask) :named A42_11))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 smt-inputs/benchmarks/verifiers/viper/pattern_augmenter/ematching/tmp/b10_1.vpr-typeEncoding-a.1_std_unique_aug-gt_unsat-full.smt2
;unknown
