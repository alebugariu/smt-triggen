...
(assert (! (forall ((a_3@@0py0 T@U)(i_1@@0py0 Int)) (! (or (not (= a_3@@0py0 nil)) (= (loc a_3@@0py0 i_1@@0py0) null)) :pattern ((loc a_3@@0py0 i_1@@0py0)) )) :named A30))
...
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil6_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
