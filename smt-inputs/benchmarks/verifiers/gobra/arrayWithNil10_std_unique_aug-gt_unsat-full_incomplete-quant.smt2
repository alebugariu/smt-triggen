...
(assert (! %lbl%+0 :named A40_0))
(assert (! %lbl%+2 :named A40_1))
(assert (! (= ZeroMask Mask@@9) :named A40_2))
(assert (! (not %lbl%@1) :named A40_3))
(assert (! (state Heap@@9 ZeroMask) :named A40_4))
(check-sat)
(get-info :reason-unknown)
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil10_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
