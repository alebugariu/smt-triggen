...
(assert (! (forall ((a_3py0 T@U)(i_1py0 Int)) (! (= (second (loc a_3py0 i_1py0)) i_1py0) :pattern ((loc a_3py0 i_1py0)) )) :named A29))
(assert (! (forall ((y_1py0 T@U)(i_1@@0py0 Int)) (! (or (not (= y_1py0 null)) (= (loc (unbox y_1py0) i_1@@0py0) null)) :pattern ((loc (unbox y_1py0) i_1@@0py0)) )) :named A30))
(assert (! %lbl%+0 :named A31_0))
(assert (! %lbl%+2 :named A31_1))
(assert (! (= ZeroMask Mask@@9) :named A31_2))
(assert (! (not %lbl%@1) :named A31_3))
(assert (! (state Heap@@9 ZeroMask) :named A31_4))
(check-sat)
(get-info :reason-unknown)
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil5_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
