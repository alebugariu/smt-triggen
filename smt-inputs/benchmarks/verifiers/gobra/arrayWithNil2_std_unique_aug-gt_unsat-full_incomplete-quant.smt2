...
(declare-fun ArrayDomainTypeType (T@T) T@T)
(declare-fun ArrayDomainTypeTypeInv0 (T@T) T@T)
(declare-fun loc (T@T T@U Int) T@U)
(declare-fun first (T@T T@U) T@U)
(declare-fun nil (T@T) T@U)
(declare-fun second (T@T T@U) Int)
(declare-fun len (T@T T@U) Int)
(declare-fun Emb42DomainTypeType (T@T) T@T)
(declare-fun Emb42DomainTypeTypeInv0 (T@T) T@T)
(declare-fun unbox42 (T@T T@U) T@U)
(declare-fun Emb17DomainTypeType (T@T) T@T)
(declare-fun Emb17DomainTypeTypeInv0 (T@T) T@T)
(declare-fun unbox17 (T@T T@U) T@U)
(declare-fun box42 (T@T T@U) T@U)
(declare-fun box17 (T@T T@U) T@U)
...
(assert (! (forall ((arg0@@6py0 T@T)) (! (= (Ctor (ArrayDomainTypeType arg0@@6py0)) 8) :pattern ((ArrayDomainTypeType arg0@@6py0)) )) :named A29_0))
(assert (! (forall ((arg0@@7py0 T@T)) (! (= (ArrayDomainTypeTypeInv0 (ArrayDomainTypeType arg0@@7py0)) arg0@@7py0) :pattern ((ArrayDomainTypeType arg0@@7py0)) )) :named A29_1))
(assert (! (forall ((a_3py0 T@U)(i_1py0 Int)(Tpy0 T@T)) (! (and (= (first Tpy0 (loc Tpy0 a_3py0 i_1py0)) a_3py0) (or (= a_3py0 (nil (ArrayDomainTypeType Tpy0))) (= (second Tpy0 (loc Tpy0 a_3py0 i_1py0)) i_1py0))) :pattern ((loc Tpy0 a_3py0 i_1py0)) )) :named A30))
(assert (! (forall ((a_3@@0py0 T@U)(T@@0py0 T@T)) (! (<= 0 (len T@@0py0 a_3@@0py0)) :pattern ((len T@@0py0 a_3@@0py0)) )) :named A31))
(assert (! (= (nil RefType) null) :named A32))
(assert (! (forall ((i_1@@0py0 Int)(T@@1py0 T@T)) (! (= (loc T@@1py0 (nil (ArrayDomainTypeType T@@1py0)) i_1@@0py0) (nil T@@1py0)) :pattern ((loc T@@1py0 (nil (ArrayDomainTypeType T@@1py0)) i_1@@0py0)) )) :named A33))
(assert (! (forall ((arg0@@8py0 T@T)) (! (= (Ctor (Emb42DomainTypeType arg0@@8py0)) 9) :pattern ((Emb42DomainTypeType arg0@@8py0)) )) :named A34_0))
(assert (! (forall ((arg0@@9py0 T@T)) (! (= (Emb42DomainTypeTypeInv0 (Emb42DomainTypeType arg0@@9py0)) arg0@@9py0) :pattern ((Emb42DomainTypeType arg0@@9py0)) )) :named A34_1))
(assert (! (forall ((i_1@@1py0 Int)(T@@2py0 T@T)) (! (= (loc T@@2py0 (unbox42 T@@2py0 (nil (Emb42DomainTypeType T@@2py0))) i_1@@1py0) (nil T@@2py0)) :pattern ((loc T@@2py0 (unbox42 T@@2py0 (nil (Emb42DomainTypeType T@@2py0))) i_1@@1py0)) )) :named A35))
(assert (! (forall ((arg0@@10py0 T@T)) (! (= (Ctor (Emb17DomainTypeType arg0@@10py0)) 10) :pattern ((Emb17DomainTypeType arg0@@10py0)) )) :named A36_0))
(assert (! (forall ((arg0@@11py0 T@T)) (! (= (Emb17DomainTypeTypeInv0 (Emb17DomainTypeType arg0@@11py0)) arg0@@11py0) :pattern ((Emb17DomainTypeType arg0@@11py0)) )) :named A36_1))
(assert (! (forall ((i_1@@2py0 Int)(T@@3py0 T@T)) (! (= (loc T@@3py0 (unbox17 T@@3py0 (nil (Emb17DomainTypeType T@@3py0))) i_1@@2py0) (nil T@@3py0)) :pattern ((loc T@@3py0 (unbox17 T@@3py0 (nil (Emb17DomainTypeType T@@3py0))) i_1@@2py0)) )) :named A37))
(assert (! (forall ((x_1py0 T@U)(T@@4py0 T@T)) (! (or (not (= (len T@@4py0 x_1py0) 42)) (= (unbox42 T@@4py0 (box42 T@@4py0 x_1py0)) x_1py0)) :pattern ((box42 T@@4py0 x_1py0)) )) :named A38))
(assert (! (forall ((y_1py0 T@U)(T@@5py0 T@T)) (! (and (= (len T@@5py0 (unbox42 T@@5py0 y_1py0)) 42) (= (box42 T@@5py0 (unbox42 T@@5py0 y_1py0)) y_1py0)) :pattern ((unbox42 T@@5py0 y_1py0)) )) :named A39))
(assert (! (forall ((x_1@@0py0 T@U)(T@@6py0 T@T)) (! (or (not (= (len T@@6py0 x_1@@0py0) 17)) (= (unbox17 T@@6py0 (box17 T@@6py0 x_1@@0py0)) x_1@@0py0)) :pattern ((box17 T@@6py0 x_1@@0py0)) )) :named A40))
(assert (! (forall ((y_1@@0py0 T@U)(T@@7py0 T@T)) (! (and (= (len T@@7py0 (unbox17 T@@7py0 y_1@@0py0)) 17) (= (box17 T@@7py0 (unbox17 T@@7py0 y_1@@0py0)) y_1@@0py0)) :pattern ((unbox17 T@@7py0 y_1@@0py0)) )) :named A41))
...
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil2_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
