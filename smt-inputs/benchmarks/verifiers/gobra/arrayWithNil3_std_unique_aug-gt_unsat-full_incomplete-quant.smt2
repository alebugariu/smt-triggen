...
(assert (! (forall ((a_3py0 T@U)(i_1py0 Int)) (! (and (= (first (loc a_3py0 i_1py0)) a_3py0) (= (second (loc a_3py0 i_1py0)) i_1py0)) :pattern ((loc a_3py0 i_1py0)) )) :named A29))
(assert (! (forall ((a_3@@0py0 T@U)) (! (<= 0 (len a_3@@0py0)) :pattern ((len a_3@@0py0)) )) :named A30))
(assert (! (forall ((x_1py0 T@U)) (! (= (unbox (box x_1py0)) x_1py0) :pattern ((box x_1py0)) )) :named A31))
(assert (! (forall ((y_1py0 T@U)) (! (= (box (unbox y_1py0)) y_1py0) :pattern ((unbox y_1py0)) )) :named A32))
(assert (! (forall ((y_1@@0py0 T@U)(i_1@@0py0 Int)) (! (and (or (not (= y_1@@0py0 null)) (= (loc (unbox y_1@@0py0) i_1@@0py0) null)) (or (not (= (loc (unbox y_1@@0py0) i_1@@0py0) null)) (= y_1@@0py0 null))) :pattern ((loc (unbox y_1@@0py0) i_1@@0py0)) )) :named A33))
(assert (! %lbl%+0 :named A34_0))
(assert (! %lbl%+2 :named A34_1))
(assert (! (= ZeroMask Mask@@9) :named A34_2))
(assert (! (not %lbl%@1) :named A34_3))
(assert (! (state Heap@@9 ZeroMask) :named A34_4))
(check-sat)
(get-info :reason-unknown)
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil3_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
