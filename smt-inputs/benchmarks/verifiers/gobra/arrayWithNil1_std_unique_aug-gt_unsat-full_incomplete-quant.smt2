...
(assert (! (forall ((i_1@@0py0 Int)) (! (= (loc nil i_1@@0py0) null) :pattern ((loc nil i_1@@0py0)) )) :named A31))
(assert (! %lbl%+0 :named A32_0))
(assert (! %lbl%+2 :named A32_1))
(assert (! (= ZeroMask Mask@@9) :named A32_2))
(assert (! (not %lbl%@1) :named A32_3))
(assert (! (state Heap@@9 ZeroMask) :named A32_4))
(check-sat)
(get-info :reason-unknown)
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil1_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
