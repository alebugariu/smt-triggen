...
(declare-fun propA (T@U) Bool)
(declare-fun propB (T@U) Bool)
(declare-fun unboxA (T@U) T@U)
(declare-fun boxEmbA (T@U) T@U)
(declare-fun unboxB (T@U) T@U)
(declare-fun boxEmbB (T@U) T@U)
(declare-fun unboxEmbA (T@U) T@U)
(declare-fun unboxEmbB (T@U) T@U)
...
(assert (! (forall ((a_3@@0py0 T@U)) (! (and (or (not (propA a_3@@0py0)) (not (propB a_3@@0py0))) (or (propA a_3@@0py0) (propB a_3@@0py0))) :pattern ((propA a_3@@0py0)) :pattern ((propB a_3@@0py0)) )) :named A30))
(assert (! (forall ((y_1py0 T@U)) (! (propA (unboxA y_1py0)) :pattern ((unboxA y_1py0)) )) :named A31))
(assert (! (forall ((y_1@@0py0 T@U)(i_1@@0py0 Int)) (! (or (= (loc (unboxA y_1@@0py0) i_1@@0py0) null) (not (= (boxEmbA y_1@@0py0) null))) :pattern ((loc (unboxA y_1@@0py0) i_1@@0py0)) )) :named A32))
(assert (! (forall ((y_1@@1py0 T@U)) (! (propB (unboxB y_1@@1py0)) :pattern ((unboxB y_1@@1py0)) )) :named A33))
(assert (! (forall ((y_1@@2py0 T@U)(i_1@@1py0 Int)) (! (or (= (loc (unboxB y_1@@2py0) i_1@@1py0) null) (not (= (boxEmbB y_1@@2py0) null))) :pattern ((loc (unboxB y_1@@2py0) i_1@@1py0)) )) :named A34))
(assert (! (forall ((x_1py0 T@U)) (! (= (boxEmbA (unboxEmbA x_1py0)) x_1py0) :pattern ((unboxEmbA x_1py0)) )) :named A35))
(assert (! (forall ((x_1@@0py0 T@U)) (! (= (boxEmbB (unboxEmbB x_1@@0py0)) x_1@@0py0) :pattern ((unboxEmbB x_1@@0py0)) )) :named A36))
(assert (! %lbl%+0 :named A37_0))
(assert (! %lbl%+2 :named A37_1))
(assert (! (= ZeroMask Mask@@9) :named A37_2))
(assert (! (not %lbl%@1) :named A37_3))
(assert (! (state Heap@@9 ZeroMask) :named A37_4))
(check-sat)
(get-info :reason-unknown)
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil8_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
