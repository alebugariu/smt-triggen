...
(declare-fun nil (T@U) Bool)
(declare-fun unboxA (T@U) T@U)
(declare-fun nilA () T@U)
(declare-fun unboxB (T@U) T@U)
(declare-fun nilB () T@U)
...
(assert (! (nil (unboxA nilA)) :named A31))
(assert (! (forall ((y_1py0 T@U)) (! (propA (unboxA y_1py0)) :pattern ((unboxA y_1py0)) )) :named A32))
(assert (! (forall ((y_1@@0py0 T@U)(i_1@@0py0 Int)) (! (or (= (loc (unboxA y_1@@0py0) i_1@@0py0) null) (not (= y_1@@0py0 nilA))) :pattern ((loc (unboxA y_1@@0py0) i_1@@0py0)) )) :named A33))
(assert (! (nil (unboxB nilB)) :named A34))
(assert (! (forall ((y_1@@1py0 T@U)) (! (propB (unboxB y_1@@1py0)) :pattern ((unboxB y_1@@1py0)) )) :named A35))
(assert (! (forall ((y_1@@2py0 T@U)(i_1@@1py0 Int)) (! (or (= (loc (unboxB y_1@@2py0) i_1@@1py0) null) (not (= y_1@@2py0 nilB))) :pattern ((loc (unboxB y_1@@2py0) i_1@@1py0)) )) :named A36))
...
;z3 smt-inputs/benchmarks/verifiers/gobra/pattern_augmenter/ematching/tmp/arrayWithNil7_std_unique_aug-gt_unsat-full.smt2 -T:600
;unknown
