...
(assert (! (forall ((arg0@@3py0 Bool)) (! (and (or (not (U_2_bool (bool_2_U arg0@@3py0))) arg0@@3py0) (or (U_2_bool (bool_2_U arg0@@3py0)) (not arg0@@3py0))) :pattern ((bool_2_U arg0@@3py0)) )) :named A1_8))
(assert (! (forall ((arg0@@4py0 Bool)) (! (= (type (bool_2_U arg0@@4py0)) boolType) :pattern ((bool_2_U arg0@@4py0)) )) :named A1_9))
...
(assert (! (forall ((arg0@@63py0 T@U)(arg1@@19py0 T@U)) (! (= (type (Set@sharp@UnionOne arg0@@63py0 arg1@@19py0)) (MapType0Type (type arg1@@19py0) boolType)) :pattern ((Set@sharp@UnionOne arg0@@63py0 arg1@@19py0)) )) :named A129))
...
(assert (! (forall ((a@@3py0 T@U)(x@@19py0 T@U)(y@@1py0 T@U)) (! (or (U_2_bool (MapType0Select (Set@sharp@UnionOne a@@3py0 x@@19py0) y@@1py0)) (not (= (type a@@3py0) (MapType0Type (type x@@19py0) boolType))) (not (= (type y@@1py0) (type x@@19py0))) (not (U_2_bool (MapType0Select a@@3py0 y@@1py0)))) :pattern ((Set@sharp@UnionOne a@@3py0 x@@19py0) (MapType0Select a@@3py0 y@@1py0)) )) :named A132))
...
;(assert (! (dummy (= (Map@sharp@Values (Map@sharp@Build (Map@sharp@Build (Map@sharp@Empty intType boolType) (int_2_U 0) (bool_2_U false)) (int_2_U 0) (bool_2_U true)))
;                     (Set@sharp@UnionOne (Map@sharp@Values (Map@sharp@Build (Map@sharp@Empty intType boolType) (int_2_U 0) (bool_2_U false))) (bool_2_U true)))) :named Repro))


(check-sat)
(get-info :reason-unknown)
;z3 -T:600 smt-inputs/benchmarks/verifiers/dafny/pattern_augmenter/ematching/tmp/dafny-issue134_std_unique_aug-gt_unsat-full.smt2
;unknown
