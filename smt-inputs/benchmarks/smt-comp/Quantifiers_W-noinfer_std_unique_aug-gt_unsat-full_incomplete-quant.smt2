...
(assert (! (or (= start_correct Smt.true) (and (= (isB o T_) Smt.true) (<= e 20))) :named A27_1))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 group_018/ematching/tmp/Quantifiers_W-noinfer_std_unique_aug-gt_unsat-full.smt2
;unknown
