...
(declare-fun call2200formal__retval_0 () Int)
...
(assert (! (<= (+ Base Limit) Size) :named A2_0))
(assert (! (<= Base max_u4) :named A2_1))
(assert (! (<= Limit max_u4) :named A2_2))
(assert (! (<= Size max_u4) :named A2_3))
(assert (! (<= min_u4 Base) :named A2_4))
(assert (! (<= min_u4 Limit) :named A2_5))
(assert (! (<= min_u4 Size) :named A2_6))
(assert (! (<= min_u4 va) :named A2_7))
(assert (! (<= va max_u4) :named A2_8))
(assert (! (= allocated_0 empty) :named A2_9))
(assert (! (= localAllocated_0 empty) :named A2_10))
(assert (! (= reads_0 empty) :named A2_11))
(assert (! (good_gmem gmem) :named A2_12))
(assert (! (good_mem mem) :named A2_13))
(assert (! (not (<= Limit va)) :named A2_14))
(assert (! (not (<= Size 0)) :named A2_15))
(assert (! (or (<= 4294967295 (+ Base va)) (and (not (<= 4294967295 (+ Base va))) (good_mem mem_0) (good_gmem gmem_0) (<= min_u4 call2200formal__retval_0) (<= call2200formal__retval_0 max_u4) (= (bl_xlat Base va) call2200formal__retval_0) (only_region_changed_or_new empty gmem gmem_0 mem mem_0) (alloc_grows gmem gmem_0) (= call2200formal__retval_0 (+ Base va)) (or (not (valid gmem_0 (add_ptr Mem (conv_u4_to_i8 call2200formal__retval_0) 4) 4)) (and (valid gmem_0 (add_ptr Mem (conv_u4_to_i8 call2200formal__retval_0) 4) 4) (or (not (contains (region (add_ptr Mem (conv_u4_to_i8 call2200formal__retval_0) 4) 4) (union reads_0 (union allocated_0 localAllocated_0)))) (and (contains (region (add_ptr Mem (conv_u4_to_i8 call2200formal__retval_0) 4) 4) (union reads_0 (union allocated_0 localAllocated_0))) (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 call2200formal__retval_0) 4))) (or (not (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 (bl_xlat Base va)) 4)))) (and (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 (bl_xlat Base va)) 4))) (or (not (valid gmem_0 Mem (conv_i4_to_u8 (* 4 Size)))) (<= Size 0)))))))))) :named A2_16))
(assert (! (valid gmem Mem (conv_i4_to_u8 (* 4 Size))) :named A2_17))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 group_024/ematching/tmp/verisoft-memvirt.c.8.bl_mem_read_std_unique_aug-gt_unsat-full.smt2
;unknown
