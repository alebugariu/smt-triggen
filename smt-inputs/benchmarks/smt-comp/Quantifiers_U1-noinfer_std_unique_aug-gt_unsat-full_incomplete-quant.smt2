...
(assert (! (or (= start_correct Smt.true) (and (= (g a b) 5) (not (= (h a (h a a)) a)))) :named A27_1))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 group_018/ematching/tmp/Quantifiers_U1-noinfer_std_unique_aug-gt_unsat-full.smt2
;unknown
