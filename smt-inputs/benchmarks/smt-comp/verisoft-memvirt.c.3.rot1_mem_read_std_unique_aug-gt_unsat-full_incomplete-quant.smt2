...
(declare-fun call729formal__retval_0 () Int)
...
(assert (! (<= min_u4 va) :named A2_2))
(assert (! (<= va max_u4) :named A2_3))
...
(assert (! (not (<= Size va)) :named A2_10))
(assert (! (or (<= Size 0) (and (not (<= Size 0)) (or (<= Size va) (and (not (<= Size va)) (good_mem mem_0) (good_gmem gmem_0) (<= min_u4 call729formal__retval_0) (<= call729formal__retval_0 max_u4) (= (rot1_xlat Size Mem va) call729formal__retval_0) (only_region_changed_or_new empty gmem gmem_0 mem mem_0) (alloc_grows gmem gmem_0) (= call729formal__retval_0 z3name!16) (or (not (valid gmem_0 (add_ptr Mem (conv_u4_to_i8 call729formal__retval_0) 4) 4)) (and (valid gmem_0 (add_ptr Mem (conv_u4_to_i8 call729formal__retval_0) 4) 4) (or (not (contains (region (add_ptr Mem (conv_u4_to_i8 call729formal__retval_0) 4) 4) (union reads_0 (union allocated_0 localAllocated_0)))) (and (contains (region (add_ptr Mem (conv_u4_to_i8 call729formal__retval_0) 4) 4) (union reads_0 (union allocated_0 localAllocated_0))) (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 call729formal__retval_0) 4))) (or (not (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 (rot1_xlat Size Mem va)) 4)))) (and (= retval (ld_u4 mem_0 (add_ptr Mem (conv_u4_to_i8 (rot1_xlat Size Mem va)) 4))) (or (not (valid gmem_0 Mem (conv_i4_to_u8 (* 4 Size)))) (<= Size 0)))))))))))) :named A2_11))
(assert (! (or (= va 0) (= z3name!16 (+ (- 1) va))) :named A2_12))
(assert (! (or (not (= va 0)) (= z3name!16 (+ (- 1) Size))) :named A2_13))
(assert (! (valid gmem Mem (conv_i4_to_u8 (* 4 Size))) :named A2_14))
(check-sat)
(get-info :reason-unknown)
;z3 -T:600 group_024/ematching/tmp/verisoft-memvirt.c.3.rot1_mem_read_std_unique_aug-gt_unsat-full.smt2
;unknown
